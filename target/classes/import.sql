...
insert into user (id,username, name) values (1,'keith', 'Keith');
insert into user (id,username, name) values (2,'erwin', 'Erwin');
insert into user (id,username, name) values (3,'jeremy', 'Jeremy');
insert into user (id, username, name) values (4,'scott', 'Scott');
